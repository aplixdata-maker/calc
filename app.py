                ...
                if excel_data and stats:
                    with results_container:
                        ...
                        if not missing_details.empty:
                            ...
                            st.caption("The following orders have SKUs that were not found in your cost sheet.")
                            st.dataframe(missing_details, use_container_width=True, hide_index=True)

                        st.divider()
                        st.markdown("### 📦 Order Status Breakdown")
                        # (Breakdown metrics follow...)
                        st.write(stats) # Simplified for brevity, you can keep your 8-column layout
